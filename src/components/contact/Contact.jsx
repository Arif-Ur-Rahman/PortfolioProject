...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_woszxvm', 'template_77juxvf', form.current, {
        publicKey: '5IU3Dj4rUdsVyXmIF',
      })
      e.target.reset()
  };
  return (
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className='contact__card-data'>rjatik990@gmail.com</span>

                        <a href="mailto:rjatik990@gmail.com" className="contact__button">Write me{" "}
                    ...
                    <div className="contact__card">
                        ...
                        <span className='contact__card-data'>+8801234567899</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className='contact__card-data'>Mazmudar atik</span>

                        <a href="https://m.me/mazumdar.atik" className="contact__button">Write me{" "}
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>
                    </div>
